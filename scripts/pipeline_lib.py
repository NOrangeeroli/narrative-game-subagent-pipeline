...
STAGE_PATHS = {
    ...
    "adventure_genre_policy": "workspace/adventure/genre-policy.json",
    "adventure_world_map": "workspace/adventure/world-map.json",
    "adventure_bindings": "workspace/adventure/bindings/narrative-bindings.json",
    "adventure_manifest": "workspace/adventure/adventure-manifest.json",
    "adventure_asset_direction": "workspace/assets/adventure/asset-direction.json",
    "adventure_asset_manifest": "workspace/assets/adventure/asset-manifest.json",
    "adventure_validation_report": "reports/adventure-validation.json",
...
def ensure_run_layout(run_root: Path) -> None:
    for relative in [
        ...
        "workspace/adventure",
        "workspace/adventure/levels",
        "workspace/adventure/interactions",
        "workspace/adventure/quests",
        "workspace/adventure/dialogue",
        "workspace/adventure/bindings",
