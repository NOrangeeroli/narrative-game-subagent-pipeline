...
| missing Advanced VN Scene IR, outcome coverage gap, fake interactable, clue/micro-activity not represented, undeclared state ref | affected `AdvancedVNSceneDesigner` |
